  ...
  return (
    <div>
      ...
      {tab === "form" && (
        <div className="card">
          ...
          <div className="grid-2" style={{ marginBottom: 20 }}>
            ...
            <div><label>Snitt sovn (timer)</label><input type="number" placeholder="7.5" step="0.1" value={form.sleepHours} onChange={e => hc("sleepHours", e.target.value)} /></div>
          </div>
          ...
          <div style={{ marginBottom: 20 }}>
            ...
            <textarea rows={3} placeholder="Akilles, justeringer, reiser, vaer, sykdom..." value={form.comments} onChange={e => hc("comments", e.target.value)} />
          </div>
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            ...
            {saved && <span style={{ fontSize: 11, color: "var(--green)", letterSpacing: "0.08em" }}>OK Lagret</span>}
          </div>
        </div>
      )}
      ...
      {tab === "history" && (
        <div>
          {weeks.length === 0 && (
            <div style={{ textAlign: "center", color: "var(--text3)", padding: "60px 0", fontSize: 13 }}>Ingen uker logget enna</div>
          )}
          {weeks.map((w, i) => (
            <div className="card" key={i} style={{ marginBottom: 12 }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                <div>
                  <div style={{ fontFamily: "'Barlow Condensed'", fontSize: 22, fontWeight: 700, letterSpacing: "0.05em" }}>
                    {w.weekStart ? `UKE ${getISOWeek(w.weekStart)}` : "-"}
                  </div>
                  {w.weekStart && (
              ...
              <div style={{ display: "flex", gap: 16, flexWrap: "wrap", marginBottom: 10 }}>
                {[
                  ...
                  [w.sleepHours && w.sleepHours + "t", "sovn", "var(--text3)"],
